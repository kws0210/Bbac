...
public class MsgListFragment extends Fragment implements NetworkThreadTask.OnCompleteListener{
    ...
    public void onSuccess(int requestCode, String responseText) {
        ...
        try {
            ...
            if ((requestCode == REQ_CODE_GET_MESSAGE_LIST) || (requestCode == REQ_CODE_GET_SEND_MESSAGE_LIST) ) {
                jsonArray = new JSONArray(responseText);
                setMsgList(jsonArray);
            } else if(requestCode == REQ_CODE_UPDATE_MESSAGE_NEW) {
            ...
            } else if(requestCode == REQ_CODE_DELETE_MESSAGE || requestCode == REQ_CODE_DELETE_SEND_MESSAGE) {
                tvAllCheck.setText(context.getString(R.string.select_all));
...
//            }
            ...
            if(isDeleteMode) {
                ...
                vh.llReplyAndTime.setVisibility(View.GONE);
                if(item.isChecked) {
                    vh.btnCheck.setBackgroundResource(R.drawable.select_pre);
                } else {
                    vh.btnCheck.setBackgroundResource(R.drawable.select_nor);
